...
function massageLegacyData (data) {
  return data.map(function (item) {
    return {
      quote: item.quote_intro,
      authorName: item.author_name,
      authorTitle: item.author_occupation,
      authorImgUrl: item.author_thumb,
...
module.exports = function (app) {
  ...
  return getInitial(logger)
    ...
    .then(function () {
      ...
      return app.models.Quote.bulkCreate(
